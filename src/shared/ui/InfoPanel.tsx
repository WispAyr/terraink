  ...
  return (
    <section className="info-panel-section">
      ...
      <p className="hug-copy">
        LocalMaps is 100% client-side and open-source. Help us build the future
          ...
          <div className="hug-row-content">
            {repoUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Open LocalMaps repository on GitHub"
              >
            ...
            {repoUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Star LocalMaps on GitHub"
              >
            ...
            {kofiUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Support LocalMaps on Ko-fi"
              >
            ...
            {socialLinks.map(({ href, Icon, label }) =>
              href ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  aria-label={`Follow LocalMaps on ${label}`}
                  title={label}
                >
